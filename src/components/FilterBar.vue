    ...
    <form class="filter__form form" action="#" @submit.prevent="submit">
      ...
      <fieldset class="form__block" v-if="currentCategories">
        ...
        <label class="form__label form__label--select">
          ...
          >
            ...
            <option
              :value="category.id"
              v-for="category in currentCategories.items"
              :key="category.title"
            >
              {{ category.title }}
            </option>
      ...
      <fieldset class="form__block" v-if="currentColors">
        ...
        <ul class="colors">
          <li
            class="colors__item"
            v-for="color in currentColors.items"
            :key="color.id"
          >
      ...
      <fieldset class="form__block" v-if="currentMaterials">
        ...
        <ul class="check-list">
          <li
            ...
            v-for="material in currentMaterials.items"
            :key="material.title"
          >
      ...
      <fieldset class="form__block" v-if="currentSeasons">
        ...
        <ul class="check-list">
          <li
            class="check-list__item"
            v-for="season in currentSeasons.items"
            :key="season.title"
          >
            <label class="check-list__label">
              <input
  ...
  methods: {
    ...
    loadColors () {
      axios.get(API_BASE_URL + '/api/colors').then((response) => {
        this.currentColors = response.data
      })
    },
    ...
    loadSeasons () {
      return axios.get(API_BASE_URL + '/api/seasons').then((response) => {
        this.currentSeasons = response.data
      })
    },
